...
main_6: 
  ...
  .data 
  STRING_29: .byte   102,   105,   98,   40,   0
  .align 2
  .text 
  #reg name $s1
  la $v0, STRING_29
...
#regData in funcInv #0 = $s2
  ...
  j EPILOG_52
  .data
FUNC_RET_ERROR_79: .asciiz "function 'fib' must return a value\n"
.text

  la $a0, FUNC_RET_ERROR_79
  j error
EPILOG_52: 
  #START EPILOG
  addu $sp, $fp, 4
