...
f_6: 
  ...
  bnez $v1, L_15
  .data
ARITH_ERROR_14: .asciiz "remainder by zero\n"
  .text
  ...
  bnez $v1, L_17
  .data
ARITH_ERROR_16: .asciiz "division by zero\n"
  .text
  la $a0, ARITH_ERROR_16
  j error
  L_17:
  div $v0, $v0, $v1
  addu $sp, $sp, 4
  ...
  bnez $v1, L_19
  .data
ARITH_ERROR_18: .asciiz "remainder by zero\n"
  .text
  la $a0, ARITH_ERROR_18
  j error
  L_19:
  rem $v0, $v0, $v1
  addu $sp, $sp, 4
  ...
  bnez $v1, L_21
  .data
ARITH_ERROR_20: .asciiz "remainder by zero\n"
  .text
  la $a0, ARITH_ERROR_20
  j error
  L_21:
  rem $v0, $v0, $v1
  addu $sp, $sp, 4
  ...
  bnez $v1, L_23
  .data
ARITH_ERROR_22: .asciiz "division by zero\n"
  .text
  la $a0, ARITH_ERROR_22
  j error
  L_23:
  div $v0, $v0, $v1
  addu $sp, $sp, 4
  ...
  bnez $v1, L_25
  .data
ARITH_ERROR_24: .asciiz "remainder by zero\n"
  .text
  la $a0, ARITH_ERROR_24
  j error
  L_25:
  rem $v0, $v0, $v1
  addu $sp, $sp, 4
  ...
  bnez $v1, L_27
  .data
ARITH_ERROR_26: .asciiz "remainder by zero\n"
  .text
  la $a0, ARITH_ERROR_26
  j error
  L_27:
  rem $v0, $v0, $v1
  addu $sp, $sp, 4
  ...
  bnez $v1, L_29
  .data
ARITH_ERROR_28: .asciiz "division by zero\n"
  .text
  la $a0, ARITH_ERROR_28
  j error
  L_29:
  div $v0, $v0, $v1
  addu $sp, $sp, 4
